...
public:
	...
	uintptr_t convertScreenSettingsPtr(ScreenSettings *ptr)
	{
		return reinterpret_cast<uintptr_t> (ptr);
	}
...
public:
	...
	{
		return (ViewMatrix*)(OFFSET_VIEWMATRIX);
	}

	uintptr_t convertViewMatrixPtr(ViewMatrix *ptr)
	{
		return reinterpret_cast<uintptr_t> (ptr);
	}
